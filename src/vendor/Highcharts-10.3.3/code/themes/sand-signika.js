...
(function (a) {
  "object" === typeof module && module.exports
    ...
    ? define("highcharts/themes/sand-signika", ["highcharts"], function (b) {
        a(b);
        a.Highcharts = b;
        return a;
      })
  ...
  b(
    a,
    "Extensions/Themes/SandSignika.js",
    [a["Core/Defaults.js"], a["Core/Globals.js"], a["Core/Utilities.js"]],
    function (a, c, b) {
      var d = a.setOptions,
        f = b.addEvent,
        g = b.createElement,
      ...
      (function (a) {
        a.options = {
          colors:
            "#338729 #498ebd #f9a030 #B21809 #ff0066 #eeaaee #55BF3B #DF5353 #7798BF #aaeeee".split(
              " "
            ),
          chart: {
        ...
        a.apply = function () {
          ...
          f(c.Chart, "afterGetContainer", function () {
  ...
  b(
    a,
    "masters/themes/sand-signika.src.js",
    [a["Core/Globals.js"], a["Extensions/Themes/SandSignika.js"]],
    function (a, b) {
      a.theme = b.options;
      b.apply();
    }
