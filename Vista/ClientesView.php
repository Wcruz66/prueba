              ...
              <div class="rd-navbar-main-outer">
                <div class="rd-navbar-main">
                  ...
                  <div class="rd-navbar-panel">
                    ...
                    <!-- RD Navbar Brand-->
                    <div class="rd-navbar-brand"><a class="brand" href="index.html"><img src="images/Lesalogo_Blanco.png" alt="" width="223" height="50"/></a></div>
                  </div>
                  <div class="rd-navbar-main-element">
                    <div class="rd-navbar-nav-wrap">
                      ...
                      <ul class="rd-navbar-nav">
                        ...
                        <li class="rd-nav-item"><a class="rd-nav-link" href="dictado.php">INSERTAR</a></li>
                        <li class="rd-nav-item"><a class="rd-nav-link" href="contacto.php">CONSULTAR</a></li>
                        <li class="rd-nav-item"><a class="rd-nav-link" href="" id="cerrarSesion">Cerrar Sesion</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
...
<div class="card-body">
          ...
          foreach ($Listord as $dato) {
            ...
            <td><input type="button" name="edit" value="Editar"  id_orden="<?php echo $dato["id_producto"]?>"   class="btn btn-warning update_data" /></td>
                <td>
                <div class="btn-toolbar" role="toolbar">
                <button type="button"  name="edit" value="Eliminar" id_orden="<?php echo $dato["id_producto"]?>" class=" btn btn-danger delete_data" >Eliminar</button>
                </div>
                </td>
            ...
            <div class="footer-minimal-bottom-panel text-sm-left">
              <div class="norow row-10 align-items-md-center">
                ...
                <div class="col-sm-6 col-md-4 order-sm-first">
                  <!-- Rights-->
                  <p class="rights"><span>&copy;&nbsp;</span><span class="copyright-year"></span> <span>LESA S.A de C.V</span>
                  </p>
                </div>
...
document.getElementById('cerrarSesion').addEventListener('click', logout);
    ...
    Swal.fire({
      ...
      allowEscapeKey: false}).then(function() {
        window.location = `https://${server}/login.html`;
    });
  }
  ...
  $(document).on('click', '.estado_data', function(){  
          var id_orden = $(this).attr("id_orden"); 
           ...
           {  
                $.ajax({  
                     url:"Controlador/OrdenController.php?accion=estado",  
                     method:"POST",  
